...
def classify_github_email(email: Dict[str, Any]) -> Dict[str, Any]:
    ...
    This adapter is internal to AfrIA Marketing Team™. It never creates a new product.
    It converts GitHub emails into execution events that DeployBot can process autonomously,
    while escalating only real exceptions: failed CI, security/compliance risk, or missing access.
    """
