...
def initialize_schema(conn: sqlite3.Connection) -> None:
    conn.executescript(
        ...
        CREATE TABLE IF NOT EXISTS assets (
            ...
            site_id TEXT NOT NULL REFERENCES sites(site_id) ON DELETE RESTRICT,
            line_id TEXT NOT NULL REFERENCES lines(line_id) ON DELETE RESTRICT,
        ...
        CREATE TABLE IF NOT EXISTS telemetry (
            ...
            UNIQUE(batch_id, point_id)
        );
        CREATE INDEX IF NOT EXISTS idx_telemetry_asset_metric_time
            ON telemetry(asset_id, metric, event_timestamp);
